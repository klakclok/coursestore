    ...
    <div id="faqs">
        <div class="questions">
            <div class="questions-item">
                <input class="questions-item__input" type="checkbox" id="question-1">
                <label class="questioan-item__trigger" for="question-1">
                    <p>Сколько раз мне нужно платить в месяц?</p>
                </label>
